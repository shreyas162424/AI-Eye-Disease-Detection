...
const Home = () => {
  ...
  const handleDemo = () => {
    ...
    const demoResult = {
      ...
      confidence: 0.98, // High confidence like a real scan
      probabilities: {
        "Glaucoma": 0.98,
        "Cataract": 0.01,
      ...
      // NOTE: Real heatmaps are generated by the backend. 
      // For a static demo, we leave these null so the UI 
      // shows the "Description" view instead of broken images.
      heatmap_png_base64: null, 
      mask_png_base64: null
    };

    // 2. Navigate with Local Image
    navigate("/results", { 
      state: { 
        result: demoResult,
        // ✅ This now points to the file you put in the public folder
        imageUrl: "/demo.jpg" 
      } 
    });
  };
